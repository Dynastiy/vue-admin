                ...
                <slot name="body">
                    <div class="row input-item">
                        <div class="form-group col-xl-4 col-md-6 col-sm-6 input-item">
                          ...
                          <input v-model="formFields.title" type="text" class="form-control" id="exampleFormControlInput12" placeholder="">
                        </div>
                        <div class="form-group col-xl-4 col-md-6 col-sm-6 input-item">
                          <label for="exampleFormControlInput2">Price</label>
                          <input v-model="formFields.price" type="text" class="form-control" id="exampleFormControlInput24" placeholder="">
                        </div>
                        <div class="col-xl-4 col-md-6 col-sm-6 input-item">
                            <label for="">Status</label>
                            <select class="custom-select" v-model="formFields.status">
                    ...
                    <div class="form-group mt-1">
                      ...
                      <textarea v-model="formFields.description" class="form-control" id="exampleFormControlTextarea12" rows="2"></textarea>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
...
export default {
    ...
    methods: {
      ...
      onFileChange(event){
    this.formFields.file = event.target.files[0];
    this.formFields.cover_page = event.target.files[0];
      },
     addResource() {
